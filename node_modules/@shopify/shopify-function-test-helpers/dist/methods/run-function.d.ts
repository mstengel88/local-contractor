 ...
 */
export declare function runFunction(fixture: FixtureData, functionRunnerPath: string, wasmPath: string, queryPath: string, schemaPath: string): Promise<RunFunctionResult>;
//# sourceMappingURL=run-function.d.ts.map