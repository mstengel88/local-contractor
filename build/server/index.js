...
const dispatch = UNSAFE_withComponentProps(function DispatchPage() {
  ...
  function assignDraggedOrder(routeId, event) {
    event.preventDefault();
    const orderId = event.dataTransfer.getData("application/x-dispatch-order-id") || event.dataTransfer.getData("text/plain") || draggedOrderId;
              ...
              children: [/* @__PURE__ */ jsxs("div", {
                ...
                children: [/* @__PURE__ */ jsxs("div", {
                  children: [/* @__PURE__ */ jsx("h2", {
                    ...
                    style: styles$6.panelSub,
                    children: ["Orders that came in by email or were typed in manually can be reviewed and routed here.", canManageDispatch ? " Drag a card onto a route to assign it." : ""]
                  })]
                }), /* @__PURE__ */ jsx("div", {
                  style: styles$6.headerPill,
                  children: "Today"
            ...
            children: [/* @__PURE__ */ jsxs("div", {
              ...
              children: [/* @__PURE__ */ jsxs("div", {
                ...
                children: routes2.map((route38) => /* @__PURE__ */ jsxs("div", {
                  ...
                  onDragLeave: () => {
                    setDragOverRouteId((current) => current === route38.id ? null : current);
                  },
