...
const dispatch = UNSAFE_withComponentProps(function DispatchPage() {
  ...
  const dispatchDetailOpen = activeView === "dashboard" && Boolean(selectedOrder && (querySelectedOrderId || (actionData == null ? void 0 : actionData.selectedOrderId)));
  if (!allowed) {
    return /* @__PURE__ */ jsx("div", {
      style: styles$3.page,
      children: /* @__PURE__ */ jsx("div", {
