      ...
      children: [/* @__PURE__ */ jsxs("aside", {
        ...
        children: [/* @__PURE__ */ jsxs("div", {
          ...
          children: [/* @__PURE__ */ jsx("a", {
            ...
            style: styles$7.sideNavLink(activeView === "dashboard"),
            children: "Dashboard"
...
function ClassicMap({
  ...
  const activeRoutes = useMemo(() => routes2.filter((route40) => route40.orders.length), [routes2]);
  const routePlan = useMemo(() => routes2.filter((route40) => route40.orders.length).map((route40) => ({
    id: route40.id,
    code: route40.code,
    truck: route40.truck,
  ...
  })).filter((route40) => route40.stops.length), [routes2]);
  ...
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [/* @__PURE__ */ jsx("div", {
      ...
      style: styles$6.mapLegend,
      children: activeRoutes.slice(0, 6).map((route40) => /* @__PURE__ */ jsxs("span", {
        style: styles$6.legendItem,
        children: [/* @__PURE__ */ jsx("span", {
          style: {
            ...styles$6.legendDot,
