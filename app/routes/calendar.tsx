...
const styles: Record<string, CSSProperties> = {
  page: {
    ["--calendar-bg" as any]: "#f5f8ed",
    ["--calendar-panel" as any]: "#ffffff",
    ["--calendar-soft" as any]: "#eef6e4",
    ["--calendar-text" as any]: "#172033",
    ["--calendar-muted" as any]: "#64748b",
    ["--calendar-border" as any]: "#d7e3d2",
    ["--calendar-blue" as any]: "#1589c8",
    ["--calendar-green" as any]: "#8cd400",
